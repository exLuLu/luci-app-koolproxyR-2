...
wget 'https://gitee.com/ledewrt/ledeproxy/raw/master/rules/yhosts.txt' -O files/usr/share/koolproxy/data/rules/yhosts.txt
wget 'https://ledewrt.coding.net/p/ledeproxy/d/rulebin/git/raw/master/rules/fanboy.txt' -O files/usr/share/koolproxy/data/rules/fanboy.txt
wget 'https://gitee.com/ledewrt/ledeproxy/raw/master/rules/easylistchina.txt' -O files/usr/share/koolproxy/data/rules/easylistchina.txt
...
wget 'https://gitee.com/ledewrt/ledeproxy/raw/master/ipsetadblock/koolproxy_ipset.conf' -O files/usr/share/koolproxy/koolproxy_ipset.conf
